...
class Binomial(Distribution):
    ...
    def __init__(self, probability: float, num_try: int) -> None:
    ...
    #TODO: write a calculate_stdev() method accordin to the specifications below.
        ...
        return math.sqrt(1.0 * self.n * self.p * (1 - self.p))


    def replace_stats_with_data(self) -> Tuple[float, float]:
    ...
    #           defined previously.
        ...
        # Set probability of positive outcome with new size n
        self.p  = len([d for d in self.data if d == 1]) / self.n * 1.0

        # Set new mean and standard deviation
    ...
    # TODO: write a method plot_bar() that outputs a bar chart of the data set according to the following specifications.
        ...
        """
        plt.hist(self.data)
        plt.label('Binominal Histogram of data')
        plt.xlabel('data')
        plt.ylabel('count')
